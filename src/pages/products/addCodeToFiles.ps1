# Define the code to be added to each file
$code = @"
...
# Get all .jsx files in the products folder
$files = Get-ChildItem -Path . -Recurse -Filter *.jsx

# Loop through each file and append the code
foreach ($file in $files) {
    Add-Content -Path $file.FullName -Value $code
    Write-Host "Code added to $($file.FullName)"
}
