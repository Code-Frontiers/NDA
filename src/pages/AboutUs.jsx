    ...
    <main className="about-us">
      ...
      <section className="mission">
        <div className="content">
          <h2>Our Mission</h2>
          <p>
            To deliver innovative solutions with a focus on quality,
            performance, and success. We are committed to excellence and aim to
            positively impact our customers and communities.
          </p>
        </div>
      </section>
      ...
      <section className="cta">
        ...
        <p>
          Be a part of a story that redefines industries and creates a better
          tomorrow.
        </p>
